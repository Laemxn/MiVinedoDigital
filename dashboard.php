...
<head>
    ...
    <!-- Cargar el CDN de Bootstrap Icons -->
    ...
    <style>
        body {
            ...
            height: 100vh;
            margin: 0;
            background-image: url('images/dashboardf.jpg'); /* Ruta de la imagen */
        ...
        .navbar {
            ...
            box-shadow: 0px 4px 12px rgba(0, 0, 0, 0.1); /* Agregar una sombra sutil */
        }
        .navbar .nav-link {
            color: #333 !important; /* Color de texto más suave */
        }
        .navbar .navbar-brand {
            color: #007aff; /* Color del logo */
        }
        .navbar-toggler-icon {
            background-color: #007aff; /* Cambiar color de icono para el menú en móviles */
        }
        ...
        .dashboard-title {
            font-size: 2rem;
            margin-bottom: 2rem;
            color: #333; /* Color de texto más oscuro para buen contraste */
        }
        .dashboard-options {
            display: grid;
        ...
        .dashboard-option {
            ...
            padding: 1rem;
            border-radius: 8px;
            background-color: #f8f9fa; /* Fondo muy suave y neutro */
